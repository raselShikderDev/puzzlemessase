...
export default function SendMessage() {
  ...
  const perseInitialMessage = (message: string) => {
  ...
  const sendMessageClick = (message: string) => {
        ...
        <Card>
          ...
          <CardContent className="flex flex-col space-y-4">
            {error ? (
              ...
              perseInitialMessage(completion).map((message, index) => (
                <Button
                  key={index}
                  variant="outline"
                  className="mb-2"
